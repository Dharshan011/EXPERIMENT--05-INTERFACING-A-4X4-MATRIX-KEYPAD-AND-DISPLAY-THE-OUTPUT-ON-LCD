...
select the target to be programmed as shown below and click on next 4.select the program name

corresponding ioc file will be generated automatically. 6.select the appropriate pins as gipo, in or out, USART or required options and configure 7.click on cntrl+S , automaticall C program will be 
generated
...
Double click on the the MCU part to open settings. Next to the Program File option, give full path to the Hex file generated using STM32Cube IDE. Then set the external crystal frequency to 8M (i.e. 8 
MHz). Click OK to save the changes. https://engineeringxpert.com/wp-content/uploads/2022/04/26.png
...
![Screenshot 2024-04-16 154037](https://github.com/Dharshan011/EXPERIMENT--05-INTERFACING-A-4X4-MATRIX-KEYPAD-AND-DISPLAY-THE-OUTPUT-ON-LCD/assets/113497491/060e4113-5ef5-41ef-8d9e-cd70a20effb4)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![Screenshot 2024-04-16 154132](https://github.com/Dharshan011/EXPERIMENT--05-INTERFACING-A-4X4-MATRIX-KEYPAD-AND-DISPLAY-THE-OUTPUT-ON-LCD/assets/113497491/071b3355-7af7-411a-ab36-a7778fabd0d9)
